...
/**
 * View class for a list of Extavium_booking.
 *
 * @since  1.6
 */
class Sv_Events_LiteViewCategories extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		DefaultHelper::addSubmenu('categories');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SV_EVENTS_LITE_TITLE_CATEGORIES'), 'categories.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_sv_events_lite&view=categories');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => JText::_('COM_SV_EVENTS_LITE_NAME'),
                        'a.`language`' => JText::_('COM_SV_EVENTS_LITE_LANGUAGE'),
		);
	}
}
