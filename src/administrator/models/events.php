...
/**
 * Methods supporting a list of Default records.
 */
class Sv_Events_LiteModelEvents extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        parent::populateState('a.datetime_start', 'DESC');
    }
    ...
    protected function getListQuery() {
        ...
        if (!empty($search)) {
            if (stripos($search, 'event_id:') === 0) {
                $query->where('a.event_id = ' . (int) substr($search, 3));
            } else {
