...
/**
 * Methods supporting a list of Extavium_booking records.
 *
 * @since  1.6
 */
class Sv_Events_LiteModelCategories extends JModelList
{
/**
	* Constructor.
	*
	...
	*/
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__sv_events_lite_categories` AS a');
